 ...
 * @author luis-d
 */
public class frm_reg_cobro_pedido_copia extends javax.swing.JInternalFrame {
     ...
     */
    public frm_reg_cobro_pedido_copia() {
        initComponents();
    ...
    private void btn_jd_registrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_jd_registrarActionPerformed
        ...
        if (tipo_pedido == 0) {
            ...
            try {
                ...
                prcProcedimientoAlmacenado.setInt("_tipo_documento", tido.getId());
            ...
            //separar pedido de productos afectos y productos inafectos
            try {
                Statement stc = con.conexion();
                String c_afectos = "select count(*) as contar, sum(dpc.cantidad * dpc.precio) as total from detalle_pedido_cliente as dpc inner join productos as p on dpc.producto "
                        + "= p.id_producto where p.afecto_igv = '1' and dpc.id = '" + pedido + "' and dpc.anio = year(current_date()) and dpc.tienda ="
                        + " '" + tienda + "' and dpc.empresa = '" + empresa + "'";
                System.out.println(c_afectos);
                ResultSet rsc = con.consulta(stc, c_afectos);
                if (rsc.next()) {
                    contar_afecto = rsc.getInt("contar");
                    suma_afecto = rsc.getDouble("total");
                }
                con.cerrar(rsc);
                con.cerrar(stc);
            } catch (Exception e) {
...
//                            + " '" + tido.getSer() + "', '" + tido.getNro() + "', '" + fecha + "', '" + fecha_pago + "', '" + pedido + "', '" + anio_periodo + "','" + suma_afecto + "', "
//                            + "'" + estado + "', NOW(), '" + vendedor + "', '1')";
//                    System.out.println(ins_venta);
//                    registro_venta_afecto = con.actualiza(st, ins_venta);
//                    con.cerrar(st);
//                } catch (Exception e) {
//                    System.out.println(e);
//                    JOptionPane.showMessageDialog(null, e.getLocalizedMessage());
//                }
                //registrar detalle de venta y agregar a kardex con venta registrada.
//                try {
//                    Statement stc = con.conexion();
//                    String c_afectos = "select dpc.producto, dpc.cantidad, dpc.precio from detalle_pedido_cliente as dpc inner join productos as p on dpc.producto "
//                            + "= p.id_producto where p.afecto_igv = '1' and dpc.id = '" + pedido + "' and dpc.anio = year(current_date()) and dpc.tienda ="
//                            + " '" + tienda + "' and dpc.empresa = '" + empresa + "'";
//                    ResultSet rsc = con.consulta(stc, c_afectos);
//                    while (rsc.next()) {
//                        mat.setId(rsc.getInt("producto"));
//                        mat.setCan(rsc.getDouble("cantidad"));
//                        mat.setPrecio(rsc.getDouble("precio"));
//
...
//                            ResultSet rsi = con.consulta(sti, bus_idk);
//                            if (rsi.next()) {
//                                id_kardex = rsi.getInt("id_kardex") + 1;
//                            } else {
//                                id_kardex = 1;
//                            }
//                            con.cerrar(rsi);
...
//                }
                ...
                //registra pago de la venta con prodcutos afecto igv
                double efectivo_afecto = 0;
                double tarjeta_afecto = 0;
                double vale_afecto = 0;
                double porcentaje_afecto = suma_afecto / total_new;
                int id_pago = 0;
                if (nuevo_efectivo > 0) {
                    efectivo_afecto = porcentaje_afecto * nuevo_efectivo;
                    try {
                        id_pago++;
                        Statement st = con.conexion();
                        String ins_pago = "insert into pago_ventas value ('" + id_pago + "', '" + id_venta + "', '" + periodo + "', '" + tienda + "', '" + empresa + "','" + fecha + "', '" + id_moneda + "', "
                                + "'" + tc + "', '" + efectivo_afecto + "', 'EFECTIVO')";
                    ...
                    try {
                        ...
                        String ins_caja = "insert into caja_chica value ('" + nro_caja + "', '" + tienda + "', '" + empresa + "','" + fecha + "', '" + id_moneda + "', '" + concepto + "', 'I', 'V', 'E',"
                                + "'" + efectivo_afecto + "', '" + frm_menu.usu.getNick() + "', NOW())";
                ...
                if (tarjeta > 0) {
                    tarjeta_afecto = porcentaje_afecto * tarjeta;
                    try {
                        id_pago++;
                        Statement st = con.conexion();
                        String ins_pago = "insert into pago_ventas value ('" + id_pago + "', '" + id_venta + "', '" + periodo + "', '" + tienda + "', '" + empresa + "','" + fecha + "', '" + id_moneda + "', "
                                + "'" + tc + "', '" + tarjeta_afecto + "', 'TARJETA')";
                        System.out.println(ins_pago);
                        con.actualiza(st, ins_pago);
                        con.cerrar(st);
                    } catch (Exception ex) {
                    ...
                    try {
                        ...
                        String ins_caja = "insert into caja_chica value ('" + nro_caja + "', '" + tienda + "', '" + empresa + "', '" + fecha + "', '" + id_moneda + "', '" + concepto + "', 'I', 'V', 'T',"
                                + "'" + tarjeta_afecto + "', '" + frm_menu.usu.getNick() + "', NOW())";
                        System.out.println(ins_caja);
                        con.actualiza(st, ins_caja);
                        con.cerrar(st);
                    } catch (Exception ex) {
                ...
                if (vale > 0) {
                    vale_afecto = porcentaje_afecto * vale;
                    try {
                        id_pago++;
                        Statement st = con.conexion();
                        String ins_pago = "insert into pago_ventas value ('" + id_pago + "', '" + id_venta + "', '" + periodo + "', '" + tienda + "', '" + empresa + "','" + fecha + "', '" + id_moneda + "', "
                                + "'" + tc + "', '" + vale_afecto + "', 'CUPON')";
                        System.out.println(ins_pago);
                        con.actualiza(st, ins_pago);
                        con.cerrar(st);
                    } catch (Exception ex) {
            ...
            //separar pedido de productos inafectos
            try {
                Statement stc = con.conexion();
                String c_afectos = "select count(*) as contar, sum(dpc.cantidad * dpc.precio) as total from detalle_pedido_cliente as dpc inner join productos as p on dpc.producto "
                        + "= p.id_producto where p.afecto_igv = '0' and dpc.id = '" + pedido + "' and dpc.anio = year(current_date()) and dpc.tienda ="
                        + " '" + tienda + "' and dpc.empresa = '" + empresa + "'";
                ResultSet rsc = con.consulta(stc, c_afectos);
                if (rsc.next()) {
                    contar_inafecto = rsc.getInt("contar");
                    suma_inafecto = rsc.getDouble("total");
                }
                con.cerrar(rsc);
                con.cerrar(stc);
            } catch (Exception e) {
            ...
            if (contar_inafecto > 0) {
                ...
                try {
                    Statement st = con.conexion();
                    String ins_venta = "insert into ventas values ('" + id_venta + "', '" + periodo + "', '" + tienda + "', '" + empresa + "','" + id_cliente + "','" + nom_cliente + "', '" + tido.getId() + "',"
                            + " '" + tido.getSer() + "', '" + tido.getNro() + "', '" + fecha + "', '" + fecha_pago + "', '" + pedido + "', '" + anio_periodo + "','" + suma_inafecto + "', "
                            + "'" + estado + "', NOW(), '" + vendedor + "', '0')";
                    System.out.println(ins_venta);
                    registro_venta_afecto = con.actualiza(st, ins_venta);
                    con.cerrar(st);
                } catch (Exception e) {
                ...
                //registra pago de la venta con prodcutos afecto igv
                double efectivo_inafecto = 0;
                double tarjeta_inafecto = 0;
                double vale_inafecto = 0;
                double porcentaje_inafecto = suma_inafecto / total_new;
                int id_pago = 0;
                if (nuevo_efectivo > 0) {
                    efectivo_inafecto = porcentaje_inafecto * nuevo_efectivo;
                    try {
                        id_pago++;
                        Statement st = con.conexion();
                        String ins_pago = "insert into pago_ventas value ('" + id_pago + "', '" + id_venta + "', '" + periodo + "', '" + tienda + "', '" + empresa + "','" + fecha + "', '" + id_moneda + "', "
                                + "'" + tc + "', '" + efectivo_inafecto + "', 'EFECTIVO')";
                        System.out.println(ins_pago);
                        con.actualiza(st, ins_pago);
                        con.cerrar(st);
                    } catch (Exception ex) {
                    ...
                    try {
                        Statement st = con.conexion();
                        String ins_caja = "insert into caja_chica value ('" + nro_caja + "', '" + tienda + "', '" + empresa + "','" + fecha + "', '" + id_moneda + "', '" + concepto + "', 'I', 'V', 'E',"
                                + "'" + efectivo_inafecto + "', '" + frm_menu.usu.getNick() + "', NOW())";
                        System.out.println(ins_caja);
                        con.actualiza(st, ins_caja);
                        con.cerrar(st);
                    } catch (Exception ex) {
                ...
                if (tarjeta > 0) {
                    tarjeta_inafecto = porcentaje_inafecto * tarjeta;
                    try {
                        id_pago++;
                        Statement st = con.conexion();
                        String ins_pago = "insert into pago_ventas value ('" + id_pago + "', '" + id_venta + "', '" + periodo + "', '" + tienda + "', '" + empresa + "','" + fecha + "', '" + id_moneda + "', "
                                + "'" + tc + "', '" + tarjeta_inafecto + "', 'TARJETA')";
                        System.out.println(ins_pago);
                        con.actualiza(st, ins_pago);
                        con.cerrar(st);
                    } catch (Exception ex) {
                    ...
                    try {
                        Statement st = con.conexion();
                        String ins_caja = "insert into caja_chica value ('" + nro_caja + "', '" + tienda + "', '" + empresa + "', '" + fecha + "', '" + id_moneda + "', '" + concepto + "', 'I', 'V', 'T',"
                                + "'" + tarjeta_inafecto + "', '" + frm_menu.usu.getNick() + "', NOW())";
                        System.out.println(ins_caja);
                        con.actualiza(st, ins_caja);
                        con.cerrar(st);
                    } catch (Exception ex) {
                ...
                if (vale > 0) {
                    vale_inafecto = porcentaje_inafecto * vale;
                    try {
                        id_pago++;
                        Statement st = con.conexion();
                        String ins_pago = "insert into pago_ventas value ('" + id_pago + "', '" + id_venta + "', '" + periodo + "', '" + tienda + "', '" + empresa + "','" + fecha + "', '" + id_moneda + "', "
                                + "'" + tc + "', '" + vale_inafecto + "', 'CUPON')";
                        System.out.println(ins_pago);
                        con.actualiza(st, ins_pago);
                        con.cerrar(st);
                    } catch (Exception ex) {
...
//            try {
//                Statement st = con.conexion();
//                String c_productos = "select dpc.producto, dpc.cantidad, dpc.precio from detalle_pedido_cliente as dpc where id = '" + pedido + "' and anio = year(current_date()) and tienda = '" + tienda + "' and empresa = '" + empresa + "'";
//                ResultSet rs = con.consulta(st, c_productos);
//                while (rs.next()) {
//                    mat.setId(rs.getInt("producto"));
//                    mat.setCan(rs.getDouble("cantidad"));
...
//                        ResultSet rsi = con.consulta(sti, ver_cant);
//                        if (rsi.next()) {
//                            mat.setCant_act(rsi.getDouble("cantidad_actual"));
//                        }
//                        con.cerrar(sti);
//                        con.cerrar(rsi);
//                    } catch (SQLException e) {
...
//                        con.actualiza(sti, act_cantidad);
//                        con.cerrar(sti);
//                    } catch (Exception e) {
//                        System.out.println(e);
//                        JOptionPane.showMessageDialog(null, e.getLocalizedMessage());
...
//            }
        ...
        this.dispose();
        frm_reg_cobro_pedido_copia venta = new frm_reg_cobro_pedido_copia();
