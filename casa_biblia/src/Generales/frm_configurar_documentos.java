...
public class frm_configurar_documentos extends javax.swing.JInternalFrame {
    ...
    private void cargar_doc() {
        ...
        try {
            String query = "select d.id_tido, d.nombre, de.serie, de.numero, de.tipo_documento from documentos_almacenes as de inner join tipo_documento as d on de.id_tido = d.id_tido "
                    + "where de.id_almacen = '" + frm_menu.alm.getCodigo() + "' order by d.nombre asc";
            ...
            t_documentos.getColumnModel().getColumn(4).setPreferredWidth(70);
            ven.centrar_celda(t_documentos, 2);
            ven.centrar_celda(t_documentos, 3);
            ven.centrar_celda(t_documentos, 4);
            con.cerrar(rs);
            con.cerrar(st);
    ...
    private void btn_modActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_modActionPerformed
        try {
            Statement st = con.conexion();
            String upd = "update documentos_almacenes set serie = '" + txt_ser.getText() + "', numero = '" + txt_nro.getText() + "' where "
                    + "id_tido = '" + id + "' and id_almacen = '" + frm_menu.alm.getCodigo() + "'";
